    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                o.secUV = TRANSFORM_TEX(v.uv, _SecondaryTex);
            ...
            {
                fixed4 secTex = tex2D(_SecondaryTex, i.uv1_uv2.zw);   
                fixed4 mainTex = tex2D(_MainTex, secTex.rg );
                fixed3 color = mainTex.rgb + step(mainTex.r, secTex.r) * secTex.a ;
